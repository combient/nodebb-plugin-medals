...
const { accountHelpers, controllerHelpers, _, translator } = require('./nodebb');
...
Controllers.renderMedalsPage = async (req, res, next) => {
	...
	const title = await translator.translate(`[[nodebb-plugin-medals:medals-page-title, ${userData.displayname}]]`);
